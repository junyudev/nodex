...
Both font families distributed with this site are licensed under the SIL Open
Font License, Version 1.1.

The Junicode webfonts are generated from the official version 2.211 variable
font release. Both Roman and Italic include Basic Latin, Latin-1 Supplement,
and the punctuation used by the English landing copy. Do not narrow them to a
single phrase: missing glyphs cause browsers to mix fallback faces inside the
display headline.
...
4. The name(s) of the Copyright Holder(s) or the Author(s) shall not be used to
   promote, endorse or advertise any Modified Version, except to acknowledge
   the contribution(s) of the Copyright Holder(s) and the Author(s) or with
