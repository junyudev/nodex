...
- Plans: default to `notes.local/living-plans/`; keep plan artifacts local rather than recreating `docs/plans/`. Read `docs/PLANS.md` for execution-plan format and requirements.
