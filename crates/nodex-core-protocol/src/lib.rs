...
mod api {
    ...
    #[utoipa::path(
        ...
        params(
            ("file_id" = String, Path),
            ("kind" = String, Query, description = "An explicit live, history, recovery, Canvas, or structural_clipboard File source"),
            ...
            ("bundle_id" = Option<String>, Query),
            ("capability" = Option<String>, Query),
            ("manifest_hash" = Option<String>, Query),
            ("store_epoch" = Option<String>, Query),
