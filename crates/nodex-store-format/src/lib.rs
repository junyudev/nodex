...
pub const PUBLISHED_STORE_FORMATS: &[PublishedStoreFormat] = &[
    ...
    format(
        151,
        "d32046ad5c4925f75d322ff2c3678202876dd4ee68d9618240aeab64695660db",
    ),
    format(
        152,
    ...
    format(
        161,
        "12053bfc2f20b68250e7ff8ff11097b9a37d669a21170d02ab5800eb58bdfef0",
    ),
    format(
        162,
        "33d2e6ebc7ff15502782edf2902c31e3777d452b5b277e18f002cf5aca196810",
    ),
    format(
        163,
        "2347e4144fc948fa58208554dabc7d148818e10729174ed0c55034bf7482e792",
    ),
    format(
        164,
        "2c6f549bfd922d8ca76ead202a6ae94e1e7145f9ee035552ee73fd1f49e69492",
    ),
    format(
        165,
        "460130364dab6853a08a49891f016fce7a93a824baebf8ac6e4f9ad5ac9e7c7e",
    ),
    format(
        166,
        "83551e9ed841ed25a03efa57284d7d70bc12a17502320ac2c2c1c4a00181cc3d",
    ),
    format(
        167,
        "b4732073b8de02508bfd5f79caeb825203e861076f7fbafa574cc0e0b4483feb",
    ),
    format(
        168,
        "f49d37a6518730ba4fb1d6e7cecc25b8c9bb5cc0369270fe1008417aa7fbcdca",
    ),
    format(
        169,
        "cf1ae506b519bf6fc55064c8ff7da678156bee84dcc774d0d4e2a92f0ab311c3",
    ),
    format(
        170,
        "7b038044ec658e42571fa0c2417723ae60b1225df8e87c7929d171f35e71d0ad",
    ),
    format(
        171,
