...
- Subagents now share consistent activity, status and navigation across the transcript and overview. Read-only details load without resuming execution; collaborative children open independent tabs and support @ mentions. The duplicate composer list is removed, and parent stop, archive and deletion follow native descendant lifecycle behavior.
