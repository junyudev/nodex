  ...
  return (
    ...
    >
      <div className="flex h-full min-h-0">
        <aside className="notion-scrollbar w-88 shrink-0 overflow-y-auto border-r border-[color-mix(in_srgb,var(--border)_75%,transparent)] bg-[color-mix(in_srgb,var(--background-secondary)_96%,transparent)]">
        ...
        <main className="notion-scrollbar min-h-0 flex-1 overflow-y-auto">
