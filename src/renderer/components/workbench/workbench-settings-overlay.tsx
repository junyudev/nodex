      ...
      <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.Content
          ...
          className={cn(
            ...
            "shadow-overlay-xl",
            "notion-scrollbar max-h-[min(24rem,var(--radix-dropdown-menu-content-available-height,24rem))] overflow-y-auto",
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      >
        ...
        {/* Backup list */}
        <div className="notion-scrollbar max-h-56 overflow-y-auto">
          {backups.length === 0 ? (
    ...
    <div className="fixed inset-0 z-50 bg-(--background) text-(--foreground)">
      ...
      >
        ...
        >
          ...
          <nav
            className="flex notion-scrollbar min-h-0 flex-1 flex-col gap-1 overflow-y-auto px-(--sidebar-shell-padding-x) py-1"
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          <div ref={scrollRef} className="notion-scrollbar min-h-0 flex-1 overflow-y-auto p-(--spacing-panel)">
