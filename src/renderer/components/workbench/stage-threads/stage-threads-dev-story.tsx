  ...
  return (
    ...
    >
      <div className="flex h-full min-h-0">
        <aside className="notion-scrollbar w-85 shrink-0 overflow-y-auto border-r border-(--border) bg-(--background-secondary)">
          <div className="space-y-4 p-4">
            ...
            <div className="space-y-2">
              ...
              <div className="notion-scrollbar max-h-40 space-y-1 overflow-y-auto rounded-md border border-(--border) bg-(--background) p-2 text-xs text-(--foreground-secondary)">
        ...
        <main className="min-w-0 flex-1 overflow-hidden p-4">
          <div className="mx-auto flex h-full min-h-0 max-w-245 flex-col gap-3">
            ...
            <section className="shrink-0 rounded-lg border border-(--border) bg-(--background) shadow-card-sm">
              ...
              <div className="notion-scrollbar h-56 overflow-y-auto px-3 py-3">
