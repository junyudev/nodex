...
export function CodeBlock({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <pre
      className={cn(
        "codex-tool-code notion-scrollbar max-h-80 overflow-auto rounded-md border border-(--border) bg-(--background) px-2.5 py-2 font-mono text-xs/normal wrap-break-word whitespace-pre-wrap",
        className,
      )}
    >
      {children}
