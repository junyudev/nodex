    ...
    <div className="w-full max-w-140 px-4">
      ...
      <div className="rounded-xl border-[0.5px] border-(--border) bg-(--background-secondary)">
        <div
          ...
          className="notion-scrollbar max-h-80 min-h-28 overflow-auto p-3"
        >
...
export function StageThreads({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-(--background)">
      ...
      <div ref={scrollRef} onScroll={updateFollowModeFromScroll} className="vertical-scroll-fade-mask-top notion-scrollbar min-h-0 flex-1 overflow-y-auto pt-(--edge-fade-distance)">
