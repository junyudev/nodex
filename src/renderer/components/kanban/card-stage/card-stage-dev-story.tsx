  ...
  return (
    ...
    >
      <div className="flex h-full min-h-0">
        <aside className="notion-scrollbar w-88 shrink-0 overflow-y-auto border-r border-(--border) bg-(--background-secondary)">
          <div className="space-y-4 p-4">
            ...
            <div className="space-y-2">
              ...
              <div className="notion-scrollbar max-h-42 space-y-1 overflow-y-auto rounded-md border border-(--border) bg-(--background) p-2">
                {actionLog.length === 0 ? (
        ...
        <main className="notion-scrollbar min-h-0 flex-1 overflow-y-auto bg-[linear-gradient(180deg,var(--background),color-mix(in_srbg,var(--background),var(--background-secondary)_42%))]">
